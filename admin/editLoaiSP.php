                                ...
                                <tbody>
                                    <?php
                                        if(isset($_GET['id'])){
                                            ...
                                            {
                                                $data = mysqli_fetch_array($loaisp);
                                            ?>
                                            <tr>
                                                <td>
                                                    <input type="hidden" value="<?= $data['id']; ?>" name="MaLoaiSP">  
                                                    <input type="text" value="<?= $data['TenLoaiSP']; ?>" name="TenLoaiSP" class="inputtextss" placeholder="nhập tên loại sp">    
                                                </td>
                                                <td>
                                                    <button class="btn btn-primary" type="submit" name="edit_loaisp_btn">Sửa</button>
                                                </td>
                                            </tr>
                                            <?php
                                            }else{

<?php
    ...
    $loai_data = getNameTheoCate("loaisp", $MaLoaiSP);
    $loaiSPUSE = mysqli_fetch_array($loai_data);
    $loai_theo_id = $loaiSPUSE['id'];
?>
		...
		<section id="new-arrivals" class="new-arrivals">
			<div class="container">
				<div class="section-header">
					<h2><?= $loaiSPUSE['TenLoaiSP']; ?></h2>
				</div>
				<div class="new-arrivals-content">
					<div class="row">
						<?php
                            $product = getProductByLoai($loai_theo_id);
